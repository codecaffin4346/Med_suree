      ...
      <div className="medsure-container py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link to="/" className="text-gray-700 hover:text-medsure-primary transition-colors">Home</Link>
            <Link to="/predict" className="text-gray-700 hover:text-medsure-primary transition-colors">Predict Cost</Link>
            <Link to="/schemes" className="text-gray-700 hover:text-medsure-primary transition-colors">Find Schemes</Link>
            <Link to="/about" className="text-gray-700 hover:text-medsure-primary transition-colors">About</Link>
          </div>
