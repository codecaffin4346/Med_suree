        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/predict" className="text-gray-200 hover:text-white transition-colors">Predict Cost</Link>
              </li>
              <li>
                <Link to="/schemes" className="text-gray-200 hover:text-white transition-colors">Find Schemes</Link>
              </li>
              <li>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/faq" className="text-gray-200 hover:text-white transition-colors">FAQ</Link>
              </li>
              <li>
                <Link to="/privacy" className="text-gray-200 hover:text-white transition-colors">Privacy Policy</Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-200 hover:text-white transition-colors">Terms of Service</Link>
              </li>
              <li>
